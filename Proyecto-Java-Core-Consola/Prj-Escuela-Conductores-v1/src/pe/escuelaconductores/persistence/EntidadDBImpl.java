...
import pe.escuelaconductores.clases.*;
...
public class EntidadDBImpl implements EntidadDB{
    ...
    "INNER JOIN estado_entidad ee ON e.idestadoentidad = ee.idestadoentidad ORDER BY e.identidad ASC";
    ...
    public Boolean insertar_SP(Entidad entidad) throws SQLException {
        ...
        try ( Connection cn = db.conectar(user); ) {
          ...
          //  PreparedStatement ps= cn.prepareStatement(SQL_INSERT_SP);
