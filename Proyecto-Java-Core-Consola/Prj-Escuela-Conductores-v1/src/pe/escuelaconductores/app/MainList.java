package pe.escuelaconductores.app;
...
public class MainList {
    ...
    public static void insertarEntidad(){
        ...
        try {
            ...
            List<Ubigeo> ubigeos = ubigeoDB.listado();
            listarUbigeos();
            ...
            while (true) {
                ...
                try {
                    idTipoEntidad = Long.valueOf(input);
                    final Long finalIdTipoEntidad = idTipoEntidad;
                    boolean existe = tipos.stream().anyMatch(t -> t.getIdTipoEntidad().equals(finalIdTipoEntidad));
                    if (existe) {
                        break;
                    } else {
